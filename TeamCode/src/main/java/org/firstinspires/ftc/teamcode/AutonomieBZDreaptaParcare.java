...
@Autonomous(name="AutonomieBZDreaptaParcareFTC", group="FTC")
//@Disabled
public class AutonomieBZDreaptaParcare extends LinearOpMode {
...
//        telemetry.update();
        ...
        if(opModeIsActive()) {
            ...
            strafeDrive(DRIVE_SPEED, 'r', 65, stdTimeOut);
            sleep(SLEEPTIME);
